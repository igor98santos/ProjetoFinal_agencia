        ...
        >
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src={imageHome1} class="d-block w-100 img-fluid" alt="..." />
            ...
            <div class="carousel-item">
              <img src={imageHome2} class="d-block w-100 img-fluid" alt="..." />
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
              <img src={imageHome3} class="d-block w-100 img-fluid" alt="..." />
              <div class="carousel-caption d-none d-md-block">
